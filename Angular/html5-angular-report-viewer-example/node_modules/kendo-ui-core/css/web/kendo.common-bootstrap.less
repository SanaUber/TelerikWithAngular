...
@kendo-slider-track-size: 8px;
@kendo-slider-track-border-width: 0px;
@kendo-slider-track-border-radius: 4px;

@kendo-slider-thumb-width: 16px;
...
@menu-item-padding-x: 1.2em;
@menu-item-padding-y: 1.2em;
...
/// @group treeview
@kendo-treeview-item-border-radius: @spacing[1];
...
@grid-header-inner-margin: -0.5em -0.6em -0.4em -0.6em;

@grid-filterable-icon-spacing: ~"calc( @{icon-size} + .6em )";
...
@kendo-signature-padding-x: @spacing[3];
@kendo-signature-padding-y: @spacing[1];
@kendo-signature-line-width: 1px;
@kendo-signature-line-style: dashed;
@kendo-signature-line-size: ~"calc( 100% - 2 * @{kendo-signature-padding-y} )";
...
@panelbar-header-padding-x: @padding-x;
@panelbar-header-padding-y: @padding-y;

@panelbar-item-padding-x: @padding-x;
@panelbar-item-padding-y: @padding-y-sm;
