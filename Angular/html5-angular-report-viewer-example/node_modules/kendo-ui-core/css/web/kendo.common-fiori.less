...
@input-border-height: ( @input-border-width * 2 );
...
@input-values-margin-y: 2px;
@input-values-margin-x: @input-values-margin-y;

@input-clear-value-text: null;
@input-clear-value-opacity: .5;
@input-clear-value-hover-text: null;
@input-clear-value-hover-opacity: 1;

@input-button-width: @button-inner-calc-size;
@input-button-border-width: 0px;
@input-spinner-width: @button-inner-calc-size;
@input-spinner-icon-offset: 2px;


// List

@kendo-list-padding-x: 0px;
@kendo-list-padding-y: 0px;

@kendo-list-font-family: @font-family;
@kendo-list-font-size: @font-size;
@kendo-list-line-height: @line-height;

@kendo-list-item-padding-x: @spacing[2];
@kendo-list-item-padding-y: @spacing[1];
@kendo-list-item-border-radius: 0px;
...
@kendo-slider-font-family: @font-family;
@kendo-slider-font-size: @font-size;
@kendo-slider-line-height: @line-height;

@kendo-slider-track-size: 2px;
@kendo-slider-track-border-width: 0px;
@kendo-slider-track-border-radius: 0px;

@kendo-slider-thumb-width: 10px;
@kendo-slider-thumb-height: 16px;
@kendo-slider-thumb-border-width: 2px;
@kendo-slider-thumb-border-radius: 0px;


// Inputs old
@input-height: @input-line-height-em;
...
// Messagebox
@messagebox-margin: 0 0 16px 0px;
...
@messagebox-line-height: @line-height;
...
@menu-item-padding-x: @padding-x;
@menu-item-padding-y: @padding-y-lg;
@menu-item-spacing: @spacing[2];
@menu-item-icon-spacing: @icon-spacing;

@menu-separator-spacing: @spacing[1];

// Menu popup
@menu-popup-padding-x: 0px;
@menu-popup-padding-y: 0px;
@menu-popup-border-width: 1px;

@menu-popup-font-size: @font-size;
@menu-popup-line-height: @line-height;

// Menu popup item
@menu-popup-item-padding-x: @spacing[2];
@menu-popup-item-padding-y: @spacing[1];

@menu-popup-item-padding-end: ~"calc( (@{menu-popup-item-padding-x} * 2) + @{icon-size} )";
@menu-popup-item-icon-margin-start: @menu-popup-item-padding-x;
@menu-popup-item-icon-margin-end: ~"calc( -1 * (@{menu-popup-item-padding-end} - @{menu-popup-item-padding-x} / 2) )";

@menu-popup-item-spacing: 0px;
...
@form-fieldset-padding-x: 0px;
@form-fieldset-padding-y: 0px;

@form-legend-margin: 0 0 16px;
@form-legend-padding-x: 0px;
@form-legend-padding-y: 0px;
@form-legend-font-size: inherit;
@form-legend-line-height: @form-line-height;
...
@form-buttons-padding-x: 0px;
@form-buttons-padding-y: 0px;
@form-buttons-border-width: 0px;
...
@toolbar-line-height: @line-height;

@toolbar-calc-inner-size: ~"calc( @{button-calc-size} + (@{toolbar-padding-y} * 2) )";

@kendo-treeview-font-family: @font-family;
/// Font size of the treeview component.
/// @group treeview
@kendo-treeview-font-size: @font-size;
/// Line height of the treeview component.
/// @group treeview
@kendo-treeview-line-height: @line-height;

/// Indentation of child groups in treeview component.
/// @group treeview
@kendo-treeview-indent: 16px;

/// Horizontal padding of treeview items.
/// @group treeview
@kendo-treeview-item-padding-x: @spacing[2];
/// Vertical padding of treeview items.
/// @group treeview
@kendo-treeview-item-padding-y: @spacing[1];
/// Border width of treeview items.
/// @group treeview
@kendo-treeview-item-border-width: 1px;
/// Border radius of treeview items.
/// @group treeview
@kendo-treeview-item-border-radius: 0px;

/// Border radius of treeview icons.
/// @group treeview
@kendo-treeview-icon-border-radius: 0px;
...
@grid-header-inner-margin: -0.929em -0.6em -0.714em -0.6em;

@grid-filterable-icon-spacing: ~"calc( @{icon-size} + 1em )";

// Calendar
@calendar-padding-x: 0px;
@calendar-padding-y: 0px;
...
@calendar-header-border-width: 0px;

@calendar-content-padding-x: 0px;
@calendar-content-padding-y: 0px;

@calendar-cell-padding-x: 1em;
@calendar-cell-padding-y: 1em;
@calendar-cell-border-radius: 0px;
@calendar-cell-line-height: @line-height;
...
@calendar-header-cell-border-width: 0px;
@calendar-header-cell-font-size: 12px;
@calendar-header-cell-line-height: @line-height;
...
@switch-handle-border-radius: 0px;
...
@switch-on-right-x: calc( (@switch-handle-size / 2) + @switch-container-padding-x + @switch-container-border-width);
...
@pager-item-border-radius: 0px;
@pager-item-spacing: 0px;

@pager-input-width: 3em;

@pager-page-size-dropdown-width: 6em;


// Pager -- old vars
@pager-button-border-radius-sm: 0px;
@pager-button-border-radius-lg: @pager-button-border-radius-sm;
@pager-button-width: 2em;
@pager-button-height: @pager-button-width;
@pager-button-margin: 0px;
...
@avatar-font-size: inherit;
@avatar-line-height: @line-height;
...
@card-deck-scroll-button-radius: 0px;
...
@breadcrumb-container-padding-x: 0px;
@breadcrumb-container-padding-y: 0px;

@breadcrumb-container-margin-x: 0px;
@breadcrumb-container-margin-y: 0px;
...
@breadcrumb-delimiter-icon-padding-y: 0px;
...
@kendo-badge-border-radius: 4px;

@kendo-badge-padding-x: 4px;
@kendo-badge-padding-x-sm: 2px;
@kendo-badge-padding-x-md: 4px;
@kendo-badge-padding-x-lg: 6px;

/// Vertical padding of the badge.
/// @group badge
@kendo-badge-padding-y: 4px;
@kendo-badge-padding-y-sm: 2px;
@kendo-badge-padding-y-md: 4px;
@kendo-badge-padding-y-lg: 6px;

/// Font sizes of the badge.
/// @group badge
@kendo-badge-font-size: 12px;
@kendo-badge-font-size-sm: 12px;
@kendo-badge-font-size-md: 12px;
@kendo-badge-font-size-lg: 12px;

/// Line heights used along with $font-size.
/// @group badge
@kendo-badge-line-height: 1;
@kendo-badge-line-height-sm: @kendo-badge-line-height;
@kendo-badge-line-height-md: @kendo-badge-line-height;
@kendo-badge-line-height-lg: @kendo-badge-line-height;

/// Badge min width used for circle badge.
/// @group badge
@kendo-badge-min-width: calc( (@kendo-badge-line-height * 1em) + (@kendo-badge-padding-y * 2) + (@kendo-badge-border-width * 2));
@kendo-badge-min-width-sm: calc( (@kendo-badge-line-height-sm * 1em) + (@kendo-badge-padding-y-sm * 2) + (@kendo-badge-border-width * 2) );
@kendo-badge-min-width-md: calc( (@kendo-badge-line-height-md * 1em) + (@kendo-badge-padding-y-md * 2) + (@kendo-badge-border-width * 2) );
@kendo-badge-min-width-lg: calc( (@kendo-badge-line-height-lg * 1em) + (@kendo-badge-padding-y-lg * 2) + (@kendo-badge-border-width * 2) );
...
@checkbox-list-margin: 0px;
@checkbox-list-padding: 0px;
...
@listview-line-height: @line-height;
...
@fab-item-icon-border-width: 0px;
...
// ActionSheet
@actionsheet-padding-x: 0px;
@actionsheet-padding-y: 0px;
...
@actionsheet-line-height: @line-height;
...
// Grid column menu
@grid-column-menu-popup-padding-x: 0px;
...
@taskboard-padding-y: 0px;
@taskboard-padding-x: 0px;
...
@taskboard-column-container-padding-y: 0px;
...
@taskboard-column-cards-padding-y: 0px;
@taskboard-column-cards-padding-x: 0px;
...
@taskboard-pane-padding-y: 0px;
@taskboard-pane-padding-x: 0px;
...
@scheduler-tooltip-border-width: 0px;
...
// Signature
@kendo-signature-width: 246px;
@kendo-signature-height: 108px;

@kendo-signature-maximized-width: 750px;
@kendo-signature-maximized-height: 252px;

@kendo-signature-padding-x: @spacing[1];
@kendo-signature-padding-y: @kendo-signature-padding-x;
@kendo-signature-line-width: 1px;
@kendo-signature-line-style: dashed;
@kendo-signature-line-size: ~"calc( 100% - 2 * @{kendo-signature-padding-x} )";
@kendo-signature-line-bottom-offset: 33%;


@kendo-signature-actions-gap: @spacing[1];
@kendo-signature-maximized-line-width: @spacing[1] - @spacing[hair];
...
@orgchart-card-body-border-width: 2px 0 0px;
...
// Tabstrip
@tabstrip-padding-x: 0px;
@tabstrip-padding-y: 0px;
@tabstrip-border-width: 0px;

@tabstrip-items-wrap-border-width: 0px;

@tabstrip-item-padding-x: 0px;
...
@pivotgrid-padding-x: 0px;
@pivotgrid-padding-y: 0px;
...
@pivotgrid-configurator-padding-x: 0px;
@pivotgrid-configurator-padding-y: 0px;
...
// ColorGradient
@colorgradient-spacer: 16px;

@colorgradient-width: 311px;
...
@colorgradient-input-width: 48px;
...
@coloreditor-spacer: 16px;

@coloreditor-min-width: 311px;
...
// ColorPicker
@colorpicker-line-height: 2.71428572em;
