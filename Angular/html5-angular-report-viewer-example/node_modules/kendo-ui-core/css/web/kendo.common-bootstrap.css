...
.k-textbox-container.k-empty:not(.k-focus) ::-webkit-input-placeholder, .k-floating-label-container.k-empty:not(.k-focus) ::-webkit-input-placeholder {
  color: transparent;
}
.k-textbox-container.k-empty:not(.k-focus) :-ms-input-placeholder, .k-floating-label-container.k-empty:not(.k-focus) :-ms-input-placeholder {
  color: transparent;
}
.k-textbox-container.k-empty:not(.k-focus) ::-ms-input-placeholder, .k-floating-label-container.k-empty:not(.k-focus) ::-ms-input-placeholder {
  color: transparent;
