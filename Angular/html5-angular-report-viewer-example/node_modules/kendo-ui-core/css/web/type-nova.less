...
@input-focus-border: lighten(@hover-text-color, 8%);
...
@kendo-slider-track-bg: @component-border;
@kendo-slider-track-border: null;
...
@footer-background-color: @widget-background-color;
...
@menu-item-bg: null;
@menu-item-text:  @link-text-color;
@menu-item-border: null;
@menu-item-gradient: null;

@menu-item-hover-bg:  @accent-hover-background;
@menu-item-hover-text:  @normal-text-color;
...
@menu-popup-item-expanded-bg: @selected-background-color;
@menu-popup-item-expanded-text: @selected-text-color;
...
/// @group treeview
@kendo-treeview-item-focus-border: @input-focus-border;
/// Box shadow of focused treeview items.
/// @group treeview
@kendo-treeview-item-focus-shadow: inset 0 0 0 1px darken(@widget-border-color, 35%);

/// Background color of treeview icons.
/// @group treeview
@kendo-treeview-icon-bg: transparent;
...
@panelbar-header-text: @panelbar-text;
...
@panelbar-header-focused-shadow: inset 0 0 0 1px @accent;
...
@panelbar-header-selected-bg: @panelbar-header-bg;
@panelbar-header-selected-text: @accent;
...
@panelbar-item-focused-shadow: inset 0 0 0 1px @accent;
...
@panelbar-item-selected-bg: fadeout(@info, 75%);
@panelbar-item-selected-text: @component-text;
...
.k-master-row {
    ...
    &.k-state-selected.k-hover .k-grid-content-sticky,
    &.k-selected.k-state-hover .k-grid-content-sticky,
