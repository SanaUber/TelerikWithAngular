...
@button-gradient: rgba( white, .1 ), rgba( white, 0 );
@button-shadow: null;

@button-hover-text-color: @button-text-color;
@button-hover-background-color: shade( @button-background-color, 10% );
@button-hover-border-color: shade( @button-background-color, 30% );
@button-hover-gradient: null;
@button-hover-shadow: null;

@button-active-background: shade( @accent, 10% );
@button-active-text-color: contrast( @accent );
@button-active-border-color: shade( @accent, 30% );
...
@primary-gradient: rgba( white, .1 ), rgba( white, 0 );
@primary-shadow: null;
...
@primary-focused-shadow: 0 0 4px 0px contrast(@background, @accent, @selected-background, 0.5);
...
@kendo-slider-thumb-bg: @component-bg;
@kendo-slider-thumb-border: @component-border;

@kendo-slider-thumb-hover-bg: @hover-bg;
@kendo-slider-thumb-hover-border: @hover-border;
...
@tooltip-callout-s-border: inherit;
...
// Menu
@menu-bg: @header-background-color;
@menu-text: @header-text-color;
@menu-border: null;
@menu-gradient: null;

@menu-item-bg: null;
@menu-item-text: @link-text;
...
/// @group treeview
@kendo-treeview-text: @component-text;
...
/// @group treeview
@kendo-treeview-item-hover-gradient: ~"@{hover-gradient}";
...
/// @group treeview
@kendo-treeview-item-selected-gradient: ~"@{selected-gradient}";
...
// Signature
@kendo-signature-line-color: rgba( @info, .24 );
...
@panelbar-header-hovered-bg: shade( @panelbar-header-bg, 10% );
...
@import "Default/button/_theme.less";
@import "Default/input/_theme.less";
@import "Default/menu/_theme.less";
@import "Default/dropdowngrid/_theme.less";
@import "Default/daterangepicker/_theme.less";
...
@import "Default/listbox/_theme.less";
@import "Default/list/_theme.less";
...
@import "Default/treeview/_theme.less";
...
.k-master-row {
    ...
    &:hover .k-grid-content-sticky.k-state-selected,
    &:hover .k-grid-content-sticky.k-selected,
    &.k-state-hover .k-grid-content-sticky.k-state-selected,
    &.k-hover .k-grid-content-sticky.k-selected {
        background-color: @grid-selected-bg;
        .composite-background(@grid-selected-gradient);
    }
