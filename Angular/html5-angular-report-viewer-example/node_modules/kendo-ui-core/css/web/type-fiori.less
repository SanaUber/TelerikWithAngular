...
@kendo-slider-thumb-hover-bg: @component-border;
@kendo-slider-thumb-hover-border: @component-border;

@kendo-slider-thumb-active-bg: @primary;
@kendo-slider-thumb-active-border: @primary;
...
@panelbar-item-selected-hovered-text: @selected-text-color;
