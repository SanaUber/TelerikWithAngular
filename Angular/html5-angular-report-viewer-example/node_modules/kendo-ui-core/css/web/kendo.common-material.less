...
@kendo-slider-thumb-height: 10px;
@kendo-slider-thumb-border-width: 0px;
@kendo-slider-thumb-border-radius: 50%;
...
@menu-popup-item-padding-y: @spacing[2];
...
/// @group treeview
@kendo-treeview-item-border-width: 0px;
...
@window-titlebar-border-width: 0px;
...
@grid-header-inner-margin: -0.786em -0.6em;
...
@switch-handle-border-width: 0px;
...
@grid-column-menu-list-item-padding-y: 0px;
...
@colorgradient-input-width: 50px;
...
// ColorPicker
@colorpicker-line-height: 2.42857143em;
...
@spreadsheet-first-tool-offset: 0px;
