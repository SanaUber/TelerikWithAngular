...
@kendo-slider-selection-bg: @base; // @primary

@kendo-slider-thumb-bg: @base; // @primary
@kendo-slider-thumb-border: @base; // @primary

@kendo-slider-thumb-hover-bg: shade( @base, 8% ); // @primary
@kendo-slider-thumb-hover-border: shade( @base, 8% ); // @primary

@kendo-slider-thumb-active-bg: shade( @base, 12% ); // @primary
@kendo-slider-thumb-active-border: shade( @base, 12% ); // @primary
...
@scheduler-nonwork-background-color: lighten(@selected-background-color, 5%);
...
/// @group treeview
@kendo-treeview-item-selected-bg: @widget-background-color;
/// Text color of selected treeview items.
/// @group treeview
@kendo-treeview-item-selected-text: @select-background-color;
