...
.k-panelbar {
    ...
    > .k-panelbar-header {
        ...
        > .k-link.k-state-focus.k-hover,
        > .k-link.k-focus.k-state-hover,
        ...
        > .k-link.k-state-selected.k-hover,
        > .k-link.k-selected.k-state-hover,
        ...
        > .k-link.k-state-selected.k-focus,
        > .k-link.k-selected.k-state-focus,
        > .k-link.k-state-selected.k-state-focused,
        > .k-link.k-selected.k-state-focused,
        ...
        > .k-ink.k-select.k-hover.k-focus {
            .fill(
