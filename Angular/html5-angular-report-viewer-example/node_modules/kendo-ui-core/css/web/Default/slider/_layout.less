...
.k-slider {
    width: min-content;
    height: min-content;
    gap: calc( @kendo-slider-thumb-width / 2 );
    ...
    &-horizontal {
        ...
        .k-draghandle {
            width: @kendo-slider-thumb-width;
            height: @kendo-slider-thumb-height;
            top: 50%;
    ...
    &-vertical {
        ...
        .k-draghandle {
            width: @kendo-slider-thumb-height;
            height: @kendo-slider-thumb-width;
            left: 50%;
            transform: translate(-50%, 50%);
        }
...
.k-slider-selection {
    ...
    .k-slider-horizontal & {
        height: @kendo-slider-track-size;
        left: 0;
        margin-top: -(@kendo-slider-track-size / 2);
        top: 50%;
    }
    ...
    .k-slider-vertical & {
        bottom: 0;
        left: 50%;
        margin-left: -(@kendo-slider-track-size / 2);
        width: @kendo-slider-track-size;
    }
}
...
.k-slider-tooltip {
    .k-callout-n,
    .k-callout-s {
        margin-left: calc(-@tooltip-callout-size / 2);
    }

    .k-callout-w,
    .k-callout-e {
        margin-top: calc(-@tooltip-callout-size / 2);
    }
}
