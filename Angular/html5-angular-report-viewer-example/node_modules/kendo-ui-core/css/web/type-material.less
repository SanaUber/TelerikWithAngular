...
// Input new
@input-text: @button-text-color;
@input-bg: @button-background-color;
...
@kendo-list-item-selected-bg: @component-bg;
...
/// @group treeview
@kendo-treeview-item-selected-bg: @hover-bg;
...
@panelbar-header-bg: @secondary-background-color;
...
@panelbar-header-selected-bg: @secondary-background-color;
...
@panelbar-header-selected-hovered-bg: shade( @panelbar-header-bg, 10% );
