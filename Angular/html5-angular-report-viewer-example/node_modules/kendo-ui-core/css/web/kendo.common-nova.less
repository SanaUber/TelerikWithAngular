...
@menu-item-padding-x: 1.071em;
@menu-item-padding-y: 1.071em;
...
// Menu popup item
@menu-popup-item-padding-x: 1.714em;
@menu-popup-item-padding-y: .5em;
...
@grid-header-inner-margin: -0.786em -0.6em -0.786em -1.286em;
...
@calendar-header-padding-x: 0px;
@calendar-header-padding-y: 0px;
...
@switch-on-left-x: calc(100% - (@switch-handle-size / 2));
@switch-on-right-x: calc( (@switch-handle-size / 2));
...
// ColorPicker
@colorpicker-line-height: 2.57142857em;
...
.k-filebrowser {
    ...
    .k-tiles-arrange .k-dropdownlist {
        width: 80px;
    }
}
