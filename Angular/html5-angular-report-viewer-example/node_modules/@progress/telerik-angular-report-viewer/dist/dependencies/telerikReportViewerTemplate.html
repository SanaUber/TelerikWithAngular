        ...
        <div class="trv-report-viewer">
            <div tabindex="3" class="trv-side-menu k-content" data-role="telerik_ReportViewer_SideMenu">
                <ul tabindex="3" aria-label="ariaLabelSideMenu">
                    ...
                    <li aria-label="ariaLabelMenuStopRendering"><a data-command="telerik_ReportViewer_stopRendering" href="#" title="menuStopRenderingTitle"><i class="k-icon k-i-x"></i><span>menuStopRenderingText</span></a></li>
                    <li aria-label="ariaLabelMenuRefresh"><a data-command="telerik_ReportViewer_refresh" href="#" title="menuRefreshTitle"><i class="k-icon k-i-refresh"></i><span>menuRefreshText</span></a></li>
                    <li aria-label="ariaLabelMenuFirstPage"><a data-command="telerik_ReportViewer_goToFirstPage" title="menuFirstPageTitle" href="#"><i class="k-icon k-i-arrow-double-60-left"></i><span>menuFirstPageText</span></a></li>
                    <li aria-label="ariaLabelMenuLastPage"><a data-command="telerik_ReportViewer_goToLastPage" title="menuLastPageTitle" href="#"><i class="k-icon k-i-arrow-double-60-right"></i><span>menuLastPageText</span></a></li>
                    ...
                    <li aria-label="ariaLabelMenuSendMail"><a data-command="telerik_ReportViewer_toggleSendEmailDialog" title="menuSendMailTitle" href="#"><i class="k-icon k-i-email"></i><span>menuSendMailText</span></a></li>
                    ...
                    <div class="trv-search-window trv-window">
                        ...
                        <div class='trv-search-dialog-input-area' role="search">
                            ...
                            <ul class="trv-search-dialog-stopsearch-placeholder">
                                <li><a data-command="telerik_ReportViewer_searchDialog_StopSearch" title="searchDialogStopTitle" aria-label="ariaLabelSearchDialogStop" href="#"><i class="k-icon k-i-x"></i></a></li>
                            </ul>
                        </div>
                        <ul aria-label="ariaLabelSearchDialogOptions" class="trv-search-dialog-search-options">
                            <li class="k-button k-button-solid k-button-solid-base">
